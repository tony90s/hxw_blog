...
from restful_api.account.views import (
    ...
    UpdateUserBackgroundView,
    SendEmailToResetPassword,
    CheckAccountIsExists,
    CheckEmailIsBind,
...
urlpatterns = [
    ...
    url(r'^list$', UserListView.as_view(), name='users'),
    ...
    url(r'^background/update$', UpdateUserBackgroundView.as_view(), name='update_user_background'),
    url(r'^password/reset/send_email$', SendEmailToResetPassword.as_view(), name='send_email_to_reset_password'),
    url(r'^is_exists$', CheckAccountIsExists.as_view(), name='check_account_is_exists'),
