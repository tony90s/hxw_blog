...
BLOG_ROOT = os.path.join(REPO_ROOT, 'hxw_blog')
ENV_ROOT = os.path.dirname(REPO_ROOT)

sys.path.append(os.path.join(BLOG_ROOT, 'djangoapps'))
...
SECRET_KEY = '0!&vxgi94q$#g&$54la@*eq92qpe+9*=jfe30u6-=d0gc#g&h%'

with open(os.path.join(ENV_ROOT, 'microsite.env.json')) as env_file:
    ENV_TOKENS = json.load(env_file)

with open(os.path.join(ENV_ROOT, 'microsite.auth.json')) as auth_file:
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(ENV_ROOT, 'log/microsite/django.log'),
            'formatter': 'standard',
            'when': 'D',
            'interval': 1,
            'encoding': 'utf-8',
